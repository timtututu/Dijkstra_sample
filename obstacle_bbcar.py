...
for i in range(len(obstacles)):
    cubeid = p.loadURDF("/home/timtu/桌面/summer program/CP214_Project-main/BulletSimulation/urdf/box.urdf",[obstacles[i][0],obstacles[i][1],0.145],p.getQuaternionFromEuler([0,0,0]),useFixedBase=1)
